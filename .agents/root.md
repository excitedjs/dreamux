...
| modify strict task-capable channels, durable task submissions, or task host events | [Task Channel Host](decisions/task-channel-host.md), [Channel runtime](reference/channel-runtime.md), [Channel routing and binding](domains/channel-routing-and-binding.md), source `packages/dreamux/src/service/channel-task-host/` |
