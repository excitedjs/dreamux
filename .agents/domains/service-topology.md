...
- Every scope that fences admission joins the work it already admitted
  through one tracker, `/packages/dreamux/src/service/in-flight-work.ts`:
  ...
  `/packages/dreamux/src/service/closed-fact.ts`; each owner builds its own
