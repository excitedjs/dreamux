...
segment before the result area, with no RESULT heading. The leading no-break
space preserves the blank line using the text result's spacing character. Actual
