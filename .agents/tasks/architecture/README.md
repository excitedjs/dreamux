...
- [Unify Team command projections](/.agents/tasks/architecture/unify-team-command-projections/README.md) — `implemented`: Expose one canonical Team projection through create, list, and status, with lifecycle status as the single status meaning.
