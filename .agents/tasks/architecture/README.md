...
- [Add Team creation context and use the dispatcher workspace by default](/.agents/tasks/architecture/extend-team-create-context/README.md) — `done`: Allow callers to attach provider-owned context to fresh Team creation and default repository-free agents to the dispatcher working directory.
