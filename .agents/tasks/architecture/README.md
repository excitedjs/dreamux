...
- [Default workspace isolation to false](/.agents/tasks/architecture/change-workspace-default/README.md) — `review`: Change only the workspace default from true to false while preserving explicit configuration.
