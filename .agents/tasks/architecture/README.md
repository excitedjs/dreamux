...
- [Default workspace isolation to false](/.agents/tasks/architecture/change-workspace-default/README.md) — `done`: Change only the workspace default from true to false while preserving explicit configuration.
