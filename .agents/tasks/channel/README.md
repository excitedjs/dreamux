...
- [Refine COT tool details and notification display](/.agents/tasks/channel/refine-cot-tool-details-and-notifications/README.md) — `review`: After #401, show actual output without an extra status line; show Complete or Failed under RESULT only when output is absent.
