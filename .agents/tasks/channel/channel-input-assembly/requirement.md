# Backfilled decision records: channel input assembly record
...
## channel-input-runtime-assembly
...
The record's own "Since This Was Recorded (2026-08-31)" section above is accurate and remains the correction of record: the routing/display split stands; its vehicles (`InboundTurnInput`, `renderChannelInput`) were deleted and assembly moved into Core.
