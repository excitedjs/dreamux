...
- Pull request / CI / merge: https://github.com/excitedjs/dreamux/pull/380 (opened 2026-09-06 on `next` from the closeout commit; CI green; merge pending the operator). #369 is closed unmerged (2026-09-06); its content ships here.
