...
- [Strengthen dispatch reminders and uppercase compaction labels](/.agents/tasks/mcp/strengthen-dispatch-and-compaction-text/README.md) — `implementation`: Restore push-based dispatch guidance, display COMPACTED SESSION in both runtime projections, and add binding notification receipts
