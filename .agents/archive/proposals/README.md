...
| [Local provider plugin store](local-provider-plugin-store.md) | [Current architecture](../../reference/current-architecture.md), [State and paths](../../reference/state-and-paths.md), [Provider references and capability registry](../../decisions/provider-references-and-capability-registry.md) |
| [Provider plugin load-session hardening](provider-plugin-load-session-hardening.md) | [Current architecture](../../reference/current-architecture.md), [Provider runtime](../../domains/provider-runtime.md), [State and paths](../../reference/state-and-paths.md) |
