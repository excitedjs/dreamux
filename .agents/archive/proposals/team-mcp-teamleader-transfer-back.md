...
> **Archived 2026-09-01.** Fully superseded: routing is Channel-owned, Team MCP has no binding tool, and there is no `transfer_back` — rebinding is the Channel's own `bind_channel` with a different Team.
