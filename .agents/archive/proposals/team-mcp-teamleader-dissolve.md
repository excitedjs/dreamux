...
> **Archived 2026-09-01.** The scoped tool landed; the durable close lifecycle did not survive (#350: a dissolve is an ordinary submission; the only surviving durable fact is a `cleanup-pending` worktree). `force` was added later and is owned by [/.agents/product/README.md](/.agents/product/README.md).
