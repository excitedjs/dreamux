...
> **Archived 2026-09-01.** Fully implemented: official-SDK MCP server, exactly three protocol revisions, structured results without text duplication. Settled rulings: [/.agents/tasks/mcp/protocol-conformance/requirement.md](/.agents/tasks/mcp/protocol-conformance/requirement.md).
