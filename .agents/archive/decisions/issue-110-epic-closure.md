...
> **Archived 2026-09-01** (decisions tree dissolved into task records). Historical point-in-time Phase 1 closure checklist; several checks (npm refs reserved-only, `dispatchers[].runtime`, the TeamMate task ledger) no longer describe the system.
