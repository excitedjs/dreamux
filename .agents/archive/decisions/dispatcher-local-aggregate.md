...
> **Archived 2026-09-01** (decisions tree dissolved into task records). The aggregate direction stands; the `TeammateRoster` shape was superseded by the service topology refactor (`TeammateCollection`) and later #350.
...
- **PR / Issue:** PR #229 / issue #209 follow-up; refines the service shape
  described by [provider-architecture-realignment](/.agents/tasks/architecture/providerization-epic/requirement.md#provider-architecture-realignment)
