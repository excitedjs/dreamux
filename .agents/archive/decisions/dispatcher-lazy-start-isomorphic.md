...
> **Archived 2026-09-01** (decisions tree dissolved into task records). Direction implemented (PR #282); most of its Required End State list was overtaken by stronger #350 deletions (`ChannelRoutes.deliver`, `channelInput`, `team_member`).
