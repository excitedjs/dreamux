...
> **Archived 2026-09-01** (decisions tree dissolved into task records). Superseded via server-hosted-teammate, then provider-architecture-realignment, and finally the #350 minimal seam. Final destination: [/.agents/tasks/architecture/minimize-provider-boundaries/](/.agents/tasks/architecture/minimize-provider-boundaries/README.md).

- **Status:** Superseded by [server-hosted-teammate](/.agents/archive/decisions/server-hosted-teammate.md)
- **Date:** 2026-06-02
...
[server-hosted-teammate](/.agents/archive/decisions/server-hosted-teammate.md): Dispatcher Service owns
