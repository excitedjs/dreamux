...
> **Archived 2026-09-01** (decisions tree dissolved into task records). Superseded by the state/config domain pages and providerized config decisions.

- **Status:** Superseded by
  [State, config, and files](/.agents/domains/state-config-and-files.md) and the
...
[State, config, and files](/.agents/domains/state-config-and-files.md) and
[Provider runtime](/.agents/domains/provider-runtime.md). The current implementation
