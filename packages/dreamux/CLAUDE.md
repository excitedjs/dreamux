...
| `mcp/` | stdio MCP shim processes (`feishu-mcp`, `teammate-mcp`, `team-mcp`, `channel-mcp` — the last is the core-hosted generic Channel MCP binding surface, #209 slice 8) | thin JSON-RPC bridges that forward to the admin socket |
