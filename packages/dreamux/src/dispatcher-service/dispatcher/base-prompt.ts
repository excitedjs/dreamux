...
export const DREAMUX_DISPATCHER_APPEND_INSTRUCTIONS = [
  ...
  '- The team MCP is the dispatcher-only Team Mode lifecycle interface: create a TeamLeader with explicit repo_cwd and leader_agent_runtime, inspect list/status/ledger, and dissolve a Team. Channel binding and Feishu routing are not part of this slice; do not imply a group chat has been handed off unless a later tool explicitly says so.',
