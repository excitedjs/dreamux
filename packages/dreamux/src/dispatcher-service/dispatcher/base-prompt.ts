export const DREAMUX_DISPATCHER_BASE_INSTRUCTIONS = [
  ...
  '- Control a running TeamMate over MCP rather than shelling out. close is idempotent for a named TeamMate, get_capabilities lists provider/runtime capabilities, and runtime-specific differences must be interpreted through those capabilities instead of branching by provider name.',
