export const DREAMUX_DISPATCHER_BASE_INSTRUCTIONS = [
  ...
  '- When a Team or TeamMate prompt-submitting tool returns success, the task was submitted successfully; Dreamux core will push the Team or TeamMate completion back automatically, so do not poll `last` or other read tools, and end the turn naturally if there is no other work.',
