...
export function recoverParallelToolBranches<TEntry extends ClaudeHistoryEntry>(
...
function isEligibleAssistant<TEntry extends ClaudeHistoryEntry>(
  entry: TEntry,
): boolean {
  return (
...
function isEligibleToolResult<TEntry extends ClaudeHistoryEntry>(
  entry: TEntry,
): boolean {
  if (
...
function stableTimestampSort<TEntry extends ClaudeHistoryEntry>(
  entries: readonly TEntry[],
): TEntry[] {
...
function timestamp(entry: ClaudeHistoryEntry): string {
